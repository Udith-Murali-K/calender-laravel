<header class="main-header">
    ...
    <a href="{{url('/admin/dashboard')}}" class="logo">
      ...
      <span class="logo-mini">{{config('settings.project-name')}}</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">{{config('settings.project-name')}}</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  ...
                  {!!Form::submit('Sign out', array('class' => 'btn btn-default btn-flat'))!!}
                  {!!Form::close()!!}
                </div>
              </li>
            </ul>
